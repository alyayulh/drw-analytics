...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::prefix('asosiasi')->name('asosiasi.')->group(function () {
        ...
        /*
        |--------------------------------------------------------------------------
        | Halaman asosiasi yang bisa diakses user login
        |--------------------------------------------------------------------------
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Khusus Admin untuk upload dan proses analisis
        |--------------------------------------------------------------------------
        */
        ...
        Route::middleware('role:Admin')->group(function () {
            ...
            /*
             | Route cadangan untuk kompatibilitas dengan Blade lama.
             | Kalau semua form sudah pakai route('asosiasi.proses'),
             | route ini boleh dihapus nanti.
             */
